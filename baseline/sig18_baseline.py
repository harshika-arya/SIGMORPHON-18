...
from sig18_data import read_dataset, UNK, EOS, NONE, WF, LEMMA, MSD
...
if __name__=='__main__':
    traindata, wf2id, lemma2id, char2id, msd2id = read_dataset("english-train-low")
    devinputdata, _, _, _, _ = read_dataset("english-dev")
    devgolddata, _, _, _, _ = read_dataset("english-test")
